...
public class BigBerthaActions {
	...
	ChatColor.BOLD + "" + ChatColor.DARK_AQUA + "Dev" + ChatColor.BOLD  + ChatColor.DARK_GRAY  + "God" +
	ChatColor.BOLD + "" + ChatColor.WHITE +"-" + ChatColor.BOLD + "" + ChatColor.DARK_RED + "EliteByte" + 
	ChatColor.BOLD + "" + ChatColor.BLACK + "]" + ChatColor.WHITE;
	
	
	/*
	 * Broadcasts the inputed String with
	 * [BigBertha] prefix.
	 */
